      ...
      <div className="w-full max-w-4xl mx-auto my-auto grid grid-cols-1 md:grid-cols-2 bg-[#111827] border border-[#263244] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 sm:p-12 bg-[#162033] border-b md:border-b-0 md:border-r border-[#263244] flex flex-col justify-between space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-[#F8FAFC]">
              Welcome back to BodhAI.
            </h2>
            <p className="text-xs text-[#94A3B8] leading-relaxed">
              Access your private conversation workspace, persistent D1 storage, and open-source Workers AI inference.
            </p>
          </div>

          <div className="p-4 bg-[#0B1220] border border-[#263244] rounded-xl space-y-1 font-mono text-[11px] text-[#94A3B8]">
            <div className="text-[#F59E0B] font-semibold">// Production Security</div>
            <div>• Web Crypto PBKDF2 Session Auth</div>
            <div>• Scoped User Data Isolation</div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center space-y-6">
          <div className="space-y-1">
            <h1 className="text-xl font-bold text-[#F8FAFC]">Sign In</h1>
            <p className="text-xs text-[#94A3B8]">Enter your credentials to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? "Signing in..." : "Sign In to BodhAI"}
            </Button>
          </form>
